...
function searchPwd_ok() {
        var f = document.searchPwdOkForm;
...
<div class="container">
	...
	<form method="post" name="searchPwdOkForm">
	<div class="confrimSelf">
		<h4 style="text-align: center;">분실된 비밀번호를 찾습니다.</h4>
		<p style="padding: 20px 0; text-align: center;">아이디와 이름 그리고 휴대폰번호를 입력해주세요. 휴대폰번호는 010-0001-0001형식으로 입력합니다.
											</p>
		<div
		...
		<div style="padding-top: 20px; border-bottom: 1px solid #e9e9e9; background-color: #fafafa; padding-bottom: 18px; text-align: center">
			<button type="button" class="btn btn-success btn-sm"
				onclick="searchPwd_ok();" style="width: 200px;">확
				인</button>
		</div>
