...
function change_ok() {
        ...
        f.action = "<%=cp%>/member/change_ok.do";
        f.submit();
}
</script>
...
<div class="container">
	...
	<form method="post" name="changeOkForm">
	<div class="confrimSelf">
		<h4 style="text-align: center;">변경할 비밀번호 입력</h4>
		<p style="padding: 20px 0; text-align: center;">변경할 비밀번호를 입력해주세요. 비밀번호는 5~10자이며 하나 이상의 숫자나 특수문자가 포함되어야
											합니다</p>
		<div
