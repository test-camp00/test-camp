...
<div class="container">
	...
	<div>
		<div class="row">
			<div class="col-md-4-2 col-md-12">
								...
								<div class="col-md-12">
									<div class="checkbox pull-right">
										<label for="join_user_agree"> <input type="checkbox"
											name="join_user_agree" id="join_user_agree" value="1" checked="checked"
                         onchange="document.memberForm.sendButton.disabled = !checked" />
											회원가입 약관에 동의합니다.
										</label>
									</div>
								</div>
...
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.
	...
	<div>
		<div class="row">
			<div class="col-md-4-2 col-md-12">
				<form role="form" name="memberForm" method="post" onsubmit="return check();">
					<div class="panel panel-default">
									...
									<div class="col-md-offset-4 col-md-10">
										<c:if test="${mode=='created'}">
											...
											<button type="button" class="btn btn-danger"
												...
												가입취소 <span class="glyphicon glyphicon-remove"></span>
											</button>
										</c:if>
										<c:if test="${mode=='update'}">
											<button type="submit" class="btn btn-primary">
												정보수정 <span class="glyphicon glyphicon-ok"></span>
											</button>
											<button type="button" class="btn btn-danger"
												onclick="javascript:location.href='<%=cp%>/';">
												수정취소 <span class="glyphicon glyphicon-remove"></span>
											</button>
										</c:if>
									</div>
								</div>
